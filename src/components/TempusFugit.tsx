...
import tempusfugit from "../../public/images/tempus-fugit/12to12.png" 
    ...
    <section id="tempusfugit" className="flex flex-col max-container pb-8 bg-[#6D7278]">
        <div className="flex flex-col mt-5 mx-5 border-[10px] border-white rounded-[16px] bg-white">
            <div className="flex flex-col pt-1">
                <p style={tribeca.style} className="flex flexCenter w-full mb-[10px] text-center uppercase tracking-[0.25em] text-[36px] text-[#6D7278]">Tempus Fugit!</p>
            </div>
            <div className="flex flex-col flexCenter bg-white mx-2.5 mb-[15px]">
                <Image src={tempusfugit} width={230} height={230} alt="Safari Ape holding an alarm with 12 minutes to 12"/>
